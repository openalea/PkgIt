...
from openalea.release.utils import checkout
...
class Mtg(Formula):
    ...
    download_name   = "mtg"     # Name of the local archive
    download_url    = "https://scm.gforge.inria.fr/svn/vplants/vplants/trunk/new_mtg"   	 # Url where to download sources (feel only if "DOWNLOAD = True")
    DOWNLOAD = BDIST_EGG = True
    
    def __init__(self,**kwargs):
        super(Mtg, self).__init__(**kwargs)
        self.dist_dir = path(self._get_dist_path())/"openalea"/"mtg"
